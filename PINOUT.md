...
| D14  | TX3       | Databox AFR Serial3 TX                        |                      | Connected to AFR wideband controller RX    |
| D15  | RX3       | Databox AFR Serial3 RX                        |                      | Connected to AFR wideband controller TX    |
...
| D22  |           | Gear Neutral switch input                     |                      | INPUT_PULLUP, inverted (LOW=triggered)     |
| D23  |           | Gear 1 switch input                           |                      | INPUT_PULLUP, inverted (LOW=triggered)     |
| D24  |           | Gear 2 switch input                           |                      | INPUT_PULLUP, inverted (LOW=triggered)     |
| D25  |           | Gear 3 switch input                           |                      | INPUT_PULLUP, inverted (LOW=triggered)     |
| D26  |           | Gear 4 switch input                           |                      | INPUT_PULLUP, inverted (LOW=triggered)     |
| D27  |           | Digital input (button bitfield, bit 5)         |                      | INPUT_PULLUP, inverted (LOW=1)             |
| D28  |           | Digital input (button bitfield, bit 6)         |                      | INPUT_PULLUP, inverted (LOW=1)             |
| D29  |           | Digital input (button bitfield, bit 7)         |                      | INPUT_PULLUP, inverted (LOW=1)             |
| D30  |           | Digital input (button bitfield, bit 8)         |                      | INPUT_PULLUP, inverted (LOW=1)             |
| D31  |           | Digital input (button bitfield, bit 9)         |                      | INPUT_PULLUP, inverted (LOW=1)             |
| D32  |           | Digital input (button bitfield, bit 10)        |                      | INPUT_PULLUP, inverted (LOW=1)             |
| D33  |           | Digital input (button bitfield, bit 11)        |                      | INPUT_PULLUP, inverted (LOW=1)             |
